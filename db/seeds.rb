...
#   end
users = [{ name: 'John', uin: '1234', email: 'j@tamu.edu', credits: 50, user_type: 'donor', date_joined: '01/01/2022' },
         { name: 'Todd', uin: '3245', email: 't@tamu.edu', credits: 10, user_type: 'recipient',
