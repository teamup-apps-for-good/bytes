...
RSpec.describe User, type: :model do
  before(:all) do
    ...
    if described_class.where(uin: '123456').empty?
      described_class.create({ name: 'John', uin: '123456', email: 'j@tamu.edu', credits: 50, user_type: 'donor',
  ...
  describe 'subtract method' do
    it 'successfully subtracts credits' do
      user = described_class.create(name: 'Tim', uin: '239404', email: 't@tamu.edu', credits: 50,
                                    user_type: 'donor', date_joined: '01/01/2022')
